actions_text = {
    "Assassinate": "ASSASSINATE: Pay 3 coins, choose player to lose card. (Can be blocked by Contessa.)",
    "Coup": "COUP: Pay 7 Coins, choose player to lose card. (Cannot be blocked or challenged.)",
    "Steal": "STEAL: Take 2 coins from another player. (Can be blocked by Captain or Ambassador.) ",
    "Take_3_coins": "TAX: Take 3 Coins. (Cannot be blocked)",
    "Foreign_aid": "FOREIGN AID: Take 2 coins. (Cannot be challenged. Can be blocked by player claiming duke)",
    "Income": "INCOME: Take 1 coin. (Cannot be blocked or challenged.)",
    "Exchange": "EXCHANGE: Take 2 cards, return 2 back to deck. (Cannot be blocked.)",
    "Block": "BLOCK: Block foreign aid, stealing, or assasination (Check card to see which you can do.)",
    "Challenge": "CHALLENGE: Challenge at any turn that allows challenges.",
    "Accept_Block": "ACCEPT BLOCK: Accept a block without a challange.",
